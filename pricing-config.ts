...
export const UNIT_PRICES: Record<string, { low: number; high: number }> = {
  ...
  '24/7 Onboard Recording': { low: 59, high: 89 },
  'Video Doorbell': { low: 200, high: 300 },
  'Motion Detectors': { low: 99, high: 129 },
  'Smoke Detectors': { low: 159, high: 159 },
  'Carbon Monoxide Detector': { low: 159, high: 159 },
  'Smart Lock - Keyless Entry': { low: 200, high: 329 },
  'Overhead Garage Door Control': { low: 200, high: 200 },
  'Mobile App & Remote Access': { low: 0, high: 0 },
  'Alarm.com Premium Integration': { low: 0, high: 0 },
  'Water Leak Sensor': { low: 99, high: 99 },
  'Glass Break Sensor': { low: 129, high: 129 },
  'Garage Door Tilt Sensor': { low: 99, high: 99 },
};
